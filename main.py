...
def main(page: ft.Page):
    ...
    def mudar_aba(e):
        # O Failsafe agora captura o estado exato garantido pelo loop da rinha
        meu_jogador.salvar() 
        print(f"[DEBUG MAIN] Salvamento Forçado na troca de aba. Vel: {meu_jogador.vel_rinha} | Dif: {meu_jogador.dif_rinha}")
